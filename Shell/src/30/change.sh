...
NAMES=( BigSur-Originals-Shell-3.x-green-dark   BigSur-Originals-Shell-3.x-grey-light    BigSur-Originals-Shell-3.x-pink-dark    BigSur-Originals-Shell-3.x-purple-light  BigSur-Originals-Shell-3.x-yellow-dark   BigSur-Originals-Shell-3.x-blue-dark   BigSur-Originals-Shell-3.x-green-light  BigSur-Originals-Shell-3.x-orange-dark   BigSur-Originals-Shell-3.x-pink-light   BigSur-Originals-Shell-3.x-red-dark      BigSur-Originals-Shell-3.x-yellow-light   BigSur-Originals-Shell-3.x-blue-light  BigSur-Originals-Shell-3.x-grey-dark    BigSur-Originals-Shell-3.x-orange-light  BigSur-Originals-Shell-3.x-purple-dark  BigSur-Originals-Shell-3.x-red-light )
# NAMES=( BigSur-Originals-Shell-3.x-blue-dark   BigSur-Originals-Shell-3.x-blue-light )
